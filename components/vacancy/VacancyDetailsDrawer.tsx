          ...
          {loading ? (
            ...
            <div className="space-y-5">
              ...
              {vacancy.noticePdfUrl && (
                <section className="rounded-none border border-[#d6e6ed] bg-white p-5 shadow-sm sm:p-6">
                  <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-[#0d837f]">{t("vacancy.vacancyNotice")}</h3>
                  <div className="mt-4">
                    <a
                      href={vacancy.noticePdfUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 rounded-none bg-[#0d837f] px-4 py-2.5 text-sm font-semibold text-white transition hover:opacity-90"
                    >
                      <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                      </svg>
                      {t("vacancy.downloadNoticePdf")}
                    </a>
                  </div>
                </section>
              )}
